# Project 18: Amazon Review Text as Marketing Intelligence
...
```bash
python scripts/01_get_amazon_sample.py --sample-size 800000 --output data/processed/all_beauty_reviews_full.csv
python scripts/02_data_audit.py --input data/processed/all_beauty_reviews_full.csv
python scripts/03_build_product_month_panel.py --input data/processed/all_beauty_reviews_full.csv --output data/processed/product_month_panel_full.csv
python scripts/04_add_text_intelligence_features.py
python scripts/06_add_complaint_topics.py
python scripts/05_baseline_prediction_models.py
```
