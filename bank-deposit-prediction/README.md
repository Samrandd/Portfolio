...
### Presentations
- `bank_deposit_technical_presentation.pdf` - Technical analysis for data scientists
- `bank_deposit_business_presentation.pdf` - Business summary for stakeholders
